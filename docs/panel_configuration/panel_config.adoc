...
Since the default time range for a panel returns data from the past to the present, you need to create a custom 
...
. Experiment with changing the time range and forecast results. The further into the future you forecast, the less authoritative the forecast will be. 