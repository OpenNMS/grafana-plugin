...
[.lead]
Welcome to the {product-title} {product-version} documentation: information and guides to help you learn about {product-title} and start exploring its features.

From creating your first dashboard to using advanced filtering, learn how to set up and manage your {product-title} environment.
