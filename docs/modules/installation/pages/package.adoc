...
This section describes how to install the {page-component-title} from a package on Debian, Ubuntu, and RPM-based Linux distributions (CentOS, Fedora, and so on).
