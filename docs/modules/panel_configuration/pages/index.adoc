...
Flow Histogram:: Bar chart that shows the distribution of flow data.
This panel expects the Flow Datasource query to have a `asTableSummary()` transform included.
+
