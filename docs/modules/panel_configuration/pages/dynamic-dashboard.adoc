...
Rather than hard-coding specific information (such as node names or resource IDs) in a panel, the {page-component-title} offers several ways to create more dynamic and interactive dashboards.
...
+
image::pc-TCP-panel.png["Example configuration settings for an {page-component-title} dashboard panel.", 500]
...
image::pc-filter-panel2.png["Example filter panel on an {page-component-title} dashboard.", 500]
