...
Each datasource has different template queries avaialble. Refer to xref:datasources[Datasources] for more information. 

There are two queries you can customize with the xref:datasources/performance_datasource.adoc#ds-perf-template[performance datasource]:
...
For more examples of variables in template queries, import the xref:https://grafana.com/grafana/dashboards/5053[OpenNMS Network Interfaces Report] sample dashboard. 

TODO: add procedure on how to import a dashboard. 
