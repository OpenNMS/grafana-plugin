...
A filter panel lets you to configure a series of variables to put on a dashboard. 
...
This procedure creates a panel that will let you to filter on alarm type and alarms that are acknowledged or in a situation.   
