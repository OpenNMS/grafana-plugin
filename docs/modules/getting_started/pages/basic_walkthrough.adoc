...
For this walk-through, we will configure a performance datasource.
Note that you can follow the same process to configure an entity or flow datasource.
...
. In the *Search* box, type *OpenNMS Performance*.
. Select the *OpenNMS Performance* datasource.
The settings dialog is displayed:
+
image::gf-data-config2.png["OpenNMS Performance datasource settings dialog displaying sample settings.", 500]
...
. Choose your data source (for example, *OpenNMS Performance*).
...
Once created, a link to the specified data will appear when you right-click an alarm in an alarms.
