...
The `nodeLocation()` query will return a list of all available nodes locations. 
This variable is meant to be used together with nodeFilter, in order to reduce the number of nodes displayed by location.
