...
Resources and Attribute fields allow `*` and `|` glob characters to create search patterns that allow you to retrieve multiple resources and attributes in a single query.
