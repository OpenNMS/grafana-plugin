...
The {page-component-title} is an application that lets you create flexible dashboards to visualize and interact with data stored by OpenNMS.
...
image::helm-sample-dash.png["The {page-component-title} displaying a sample dashboard, populated with bar graphs and pie charts."]
