...
OpenNMS Horizon/Meridian includes three templates to https://docs.opennms.com/horizon/28.0.0/operation/database-reports/database.html#creating-a-pdf-of-a-grafana-dashboard[create a PDF report] from an existing Grafana dashboard. 
