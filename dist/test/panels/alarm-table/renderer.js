...
var TableRenderer = exports.TableRenderer = function () {
  ...
  _createClass(TableRenderer, [{
    ...
    value: function getTicketActionsHtml(source, alarm) {
      ...
      if (!alarm.troubleTicketState || alarm.troubleTicketState === _opennms.Model.TroubleTicketStates.CREATE_FAILED) {
      ...
      if (alarm.troubleTicketState && (alarm.troubleTicketState === _opennms.Model.TroubleTicketStates.OPEN || alarm.troubleTicketState == _opennms.Model.TroubleTicketStates.CLOSE_FAILED)) {
