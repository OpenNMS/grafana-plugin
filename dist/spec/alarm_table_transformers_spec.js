...
System.register(['../panels/alarm-table/transformers', '../panels/alarm-table/table_model'], function (_export, _context) {
  "use strict";

  var transformers, TableModel;
  return {
    setters: [function (_panelsAlarmTableTransformers) {
      transformers = _panelsAlarmTableTransformers.transformers;
    }, function (_panelsAlarmTableTable_model) {
      TableModel = _panelsAlarmTableTable_model.TableModel;
    }],
    execute: function () {
