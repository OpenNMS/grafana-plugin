...
System.register(["../datasources/mock-fault-ds/module", "q", "lodash"], function (_export, _context) {
  "use strict";

  var Datasource, Q, _;

  return {
    setters: [function (_datasourcesMockFaultDsModule) {
      Datasource = _datasourcesMockFaultDsModule.Datasource;
    }, function (_q) {
      Q = _q.default;
    }, function (_lodash) {
      _ = _lodash.default;
      ...
      describe('OpenNMS_Mock_FaultManagement_Datasource', function () {
        ...
        it('should include meta-data in the rows', function (done) {
          ...
          ctx.ds.query({ targets: ['foo'] }).then(function (result) {
            expect(result.data).to.have.length(1);
            expect(result.data[0].rows).to.have.length(1);
            _.each(result.data[0].rows, function (row) {
              // Datsource name
...
//# sourceMappingURL=mock_fm_datasource_spec.js.map
