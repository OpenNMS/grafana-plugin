...
System.register(['lodash', '../panels/alarm-table/selection_mgr'], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_lodash) {
      _ = _lodash.default;
    }, function (_panelsAlarmTableSelection_mgr) {
      SelectionMgr = _panelsAlarmTableSelection_mgr.SelectionMgr;
    }],
    execute: function () {
      ...
      describe('Selection Manager', function () {
        ...
        beforeEach(function () {
          currentSelection = [];
          mgr = new SelectionMgr(function (from, to) {
